...
const nationalities = [
  ...
  "Andorran", "Angolan", "Anguillan", "Citizen of Antigua and Barbuda", "Argentine",
...
document.addEventListener("sectionsLoaded", () => {
  const datalist = document.getElementById("nationalityList");
  if (!datalist) {
    console.error("nationalityList not found");
    return;
  }
  ...
  console.log("Nationality list loaded");
});